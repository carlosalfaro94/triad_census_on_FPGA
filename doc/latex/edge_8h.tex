...
\begin{center}
\leavevmode
\includegraphics[width=192pt]{edge_8h__dep__incl}
\end{center}
\end{figure}
\subsection*{Typedefs}
...
\begin{DoxyCompactList}\small\item\em Function that returns the neighobor id of an edge. \end{DoxyCompactList}\item 
...
\end{DoxyParams}
\begin{DoxyReturn}{Returns}
uint32\+\_\+t\+: The direction of the edge 
\end{DoxyReturn}
...
Function that returns the neighobor id of an edge. 
